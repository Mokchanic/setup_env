...
## Make moveit2_ws
export MOVEIT_WS=~/ros_workspace/moveit2_ws
...
cd ~/ros_workspace/moveit2_ws
colcon build --mixin release --parallel-workers 1

## Setup moveit2_ws
source ~/ros_workspace/moveit2_ws/install/setup.bash
echo 'source ~/ros_workspace/moveit2_ws/install/local_setup.bash' >> ~/.bashrc
